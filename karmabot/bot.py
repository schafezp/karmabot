...
from .handlers import (
    ...
    gen_show_user_stats,
    gen_show_chat_info,
    gen_show_history_graph,
    gen_clear_chat_with_bot,
    gen_show_karma_personally,
    gen_show_karma_personally_button_pressed,
    error,
)
...
def main():
    ...
    showkarma_handler = CommandHandler(
        SHOW_KARMA_COMMAND, gen_show_karma(db_service), pass_args=True
    )
    ...
    dispatcher.add_handler(
        CallbackQueryHandler(gen_show_karma_personally_button_pressed(db_service))
    )
